...
static std::vector<ExperimentConfig> g_experiments = {
    ...
    {"deep-image-96-angular",      "cd", 100,  1.0f, 16.0f, 0.95f, 0.98f, 5000, 3, 5000, 10, 3, 1 + 32 + 31 * 32},
    {"glove-100-angular",          "cd", 100,  1.0f, 16.0f, 0.95f, 0.98f, 5000, 3, 5000, 10, 3, 1 + 32 + 31 * 32},
    {"word2vec-300-angular",       "cd", 100,  1.0f, 16.0f, 0.95f, 0.98f, 1000, 3, 5000, 10, 3, 1 + 32 + 31 * 32},
    {"sift10m-128-euclidean",      "l2", 100,  1.0f, 16.0f, 0.95f, 0.98f, 1000, 3, 5000, 10, 3, 1 + 32 + 31 * 32},
    {"gist-960-euclidean",         "l2", 100,  1.0f, 16.0f, 0.95f, 0.98f, 5000, 3, 5000, 10, 3, 1 + 32 + 31 * 32},
    {"tiny5m-384-euclidean",       "l2", 100,  1.0f, 16.0f, 0.95f, 0.98f, 5000, 3, 5000, 10, 3, 1 + 32 + 31 * 32},
    {"msmarco",                    "cd", 1000, 1.0f, 16.0f, 0.95f, 0.98f, 5000, 3, 5000, 10, 3, 1 + 32 + 31 * 32},
    {"cohere",                     "cd", 1000, 1.0f, 16.0f, 0.95f, 0.98f, 5000, 3, 5000, 10, 3, 1 + 32 + 31 * 32},
    // {"cluster_mg_uniform_100d",    "cd", 1000, 1.0f, 16.0f, 0.95f, 0.98f, 1000, 10, 5000, 10, 3, 1 + 32 + 31 * 32},
    // {"cluster_mg_zipf_100d",       "cd", 1000, 1.0f, 16.0f, 0.95f, 0.98f, 5000, 10, 5000, 10, 3, 1 + 32 + 31 * 32}
    // {"laion_image",                "cd", 1000, 1.0f, 16.0f, 0.95f, 0.98f, 5000, 10, 5000, 10, 3, 1 + 32 + 31 * 32},
    // {"laion_text",                 "cd", 1000, 1.0f, 16.0f, 0.95f, 0.98f, 5000, 10, 5000, 10, 3, 1 + 32 + 31 * 32}
};
