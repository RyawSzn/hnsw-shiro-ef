...
for i in tqdm(range(0, 89)):
    with gzip.open(f'/mnt/d/RyawSzn_/Downloads/msmarco-passage-openai-ada2/{i}.jsonl.gz', 'rt', encoding='utf-8') as f:
        for line in f:
...
with gzip.open('/mnt/d/RyawSzn_/Downloads/msmarco-passage-openai-ada2/topics.msmarco-passage.dev-subset.openai-ada2.jsonl.gz', 'rt', encoding='utf-8') as f:
    for line in f:
        data = json.loads(line)
...
with h5py.File("/home/ryawszn/experiments/shiro-ef/data/msmarco.hdf5", "w") as h5f:
