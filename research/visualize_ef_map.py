...
if __name__ == "__main__":
    ...
    if not target_dir.exists() or not target_dir.is_dir():
        ...
        print("Please ensure EXPERIMENTS_ROOT is set correctly or the directory exists.")
        sys.exit(1)
    ...
    idx_str = input("\nEnter the number of the dataset to visualize (or 'all'): ").strip().lower()
    ...
    replace_str = input("Overwrite existing images if they exist? (y/n) [n]: ").strip().lower()
